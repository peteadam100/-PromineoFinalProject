 ...
 * 
 */
package com.promineo.games.errorhandler;
...
public class ControllerExceptionHandler {
  ...
  public Map<String, Object> handleException(Exception e, WebRequest webRequst) {
    return createExceptionMessage(e, HttpStatus.INTERNAL_SERVER_ERROR, webRequst,
  ...
  private Map<String, Object> createExceptionMessage(Exception e, HttpStatus status,
    ...
    if (logStatus == LogStatus.MESSAGE_ONLY) {
      ...
      log.error("Unplanned Exception:", e);
    }
